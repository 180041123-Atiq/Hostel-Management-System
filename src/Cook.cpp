...
void Cook::disk_in()
{
    ...
    if(!infile)
    {
        std::cout<<"there are no file for cook"<<std::endl;
        return ;
    }
    obj[k]=new Cook;
...
void Cook::del_own_rec()
{
    ...
    if(!infile)
    {
        std::cout<<"There is no cook to delete"<<std::endl;
        flag1=false;
    }
    if(flag1==true)
    {
...
bool Cook::login_op()
{
    ...
    if(!infile)
    {
        std::cout<<"Sorry, there is no cook right now"<<std::endl;
        return false;
    }
    std::string L_id,L_pwd;
    std::cout<<"Welcome to Cook's login terminal."<<std::endl;
...
void Cook::main_func_cok()
{
    ...
    if(!infile)
    {
        std::cout<<"There is no food."<<std::endl;
        flag=false;
    }
    if(flag==true)
    {
    ...
    infile.close();
    std::cout<<"Which you want to add?"<<std::endl;
    std::cout<<"Press 1 for setA"<<std::endl;
    std::cout<<"press 2 for setB"<<std::endl;
    std::cout<<"press 3 for setC"<<std::endl;
    int x;
    std::cin>>x;
    if(x==1)
        a++;
